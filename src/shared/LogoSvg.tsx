const LogoSvg = () => {
  return (
    <svg className="block w-full dark:hidden" viewBox="0 0 180 50" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Truck body */}
      <path
      ...
      {/* PickIt text */}
      <text x="70" y="35" fontFamily="Arial, sans-serif" fontSize="28" fontWeight="bold" fill="#1a3a5c">
        <tspan>Picklt</tspan>
      </text>
    </svg>
  )
